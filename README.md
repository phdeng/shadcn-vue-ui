...
**Console Dashboard（亮色模式）**
![Console Dashboard](docs/screenshots/console-dashboard.png)

**Console Dashboard（暗色模式）**
![Console Dashboard Dark](docs/screenshots/console-dashboard-dark.png)

**模型管理**
![Models](docs/screenshots/console-models.png)

**ChatAgent 对话**
![ChatAgent](docs/screenshots/console-chat.png)

**登录页**
![Login](docs/screenshots/console-login.png)

**Business Dashboard**
![Business Dashboard](docs/screenshots/business-dashboard.png)

**Business 用户管理**
![Business Users](docs/screenshots/business-users.png)

## 双子项目

| 子项目 | 定位 | 状态 |
|--------|------|------|
| **shadcn-vue-ui-console** | AI 基础设施与平台能力管理控制台 | ✅ 14 页面 |
| **shadcn-vue-ui-business** | 通用业务管理与运营后台 | ✅ 开发中 |
