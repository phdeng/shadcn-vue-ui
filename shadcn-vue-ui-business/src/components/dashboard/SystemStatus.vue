...
const services = ref<{ name: string, status: ServiceState }[]>([
  ...
  { name: '支付网关', status: 'healthy' },
  { name: '内容服务', status: 'healthy' },
  { name: '通知服务', status: 'degraded' },
  { name: '文件存储', status: 'healthy' },
  { name: '缓存服务', status: 'healthy' },
  { name: '搜索引擎', status: 'healthy' },
  { name: '日志服务', status: 'healthy' },
  { name: '监控告警', status: 'healthy' },
])
