...
import { authGlobalInit, authStorageInit, configureAuthSession, setAuthProvider } from '@seontechnologies/playwright-utils/auth-session'
...
const myCustomProvider: AuthProvider = {
  ...
  isTokenExpired: (storageState) => {
    ...
    return Date.now() > Number.parseInt(expiresAt?.value || '0')
  },
